...
export default function Filter() {
  return (
    <section className="flex flex-col  gap-5 mx-4 xl:mx-20 2xl:mx-40 my-6 xl:my-20">
      <div className="flex flex-row gap-5 rounded-xl p-2.5 outline outline-[#262626]">
        <input
          ...
          id=""
        />
        <button className="px-5 py-3.5 bg-violet-600 rounded-lg">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
      ...
      <div className="flex flex-col gap-3.5 bg-[#1A1A1A] p-4 rounded-xl">
        <SearchItem
