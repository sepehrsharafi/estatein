export default function OurAchievements() {
  function InfoItem({
    ...
    infoItems: Array<{ title: string; description: string }>;
  }) {
    return (
      <section
        ...
        {infoItems.map(
          (item: { title: string; description: string }, index) => (
            <div className="bg-[#1A1A1A] gap-2.5 p-2 rounded-[14px] xl:rounded-[16px]">
              ...
              >
                <h3 className="text-white font-semibold text-lg xl:text-2xl 2xl:text-3xl">
                  {item.title}
                </h3>
  ...
  return (
    <section className="flex flex-col  gap-5 mx-4 xl:mx-20 2xl:mx-40 my-6 xl:my-10">
