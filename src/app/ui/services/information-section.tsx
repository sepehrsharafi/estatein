...
export default function InformationSection() {
  function InfoItem({
    ...
    return (
      <article className="flex flex-col gap-4 xl:gap-5 p-6 xl:p-10 border-[1px] border-[#262626] rounded-[10px] xl:rounded-[12px]">
  ...
  function CTAItem() {
    return (
      <article className="h-full my-auto relative flex flex-col gap-4 bg-[#1A1A1A] p-6 border-[1px] border-[#262626] rounded-[10px] xl:rounded-[12px]">
        <svg
  ...
  return (
    <section className="mx-4 xl:mx-20 2xl:mx-40 xl:mt-10">
