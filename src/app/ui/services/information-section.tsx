...
export default function InformationSection({
  ...
  CTAItems: { title: string; description: string };
}) {
  function InfoItem({
    infoItems,
  }: {
      ...
      <>
        {infoItems.map(
          (
            ...
            <article
              key={index}
              className="flex flex-col gap-4 xl:gap-5 p-6 xl:p-10 border-[1px] border-[#262626] rounded-[10px] xl:rounded-[12px]"
            >
  ...
  function CTAItem({
    ...
    return (
      <article className="h-full my-auto relative flex flex-col justify-center gap-4 bg-[#1A1A1A] p-6 border-[1px] border-[#262626] rounded-[10px] xl:rounded-[12px]">
        <svg
        ...
        <div className="flex flex-col xl:flex-row gap-4 items-center justify-between">
          ...
          <button className="z-10 text-white font-medium text-base 2xl:text-lg bg-[#141414] w-full xl:w-fit px-5 py-3.5  border-[1px] border-[#262626] rounded-[8px]">
            Learn More
          </button>
        </div>
        <p className="z-10 text-neutral-400 font-medium text-base 2xl:text-lg">
          {CTAItems.description}
        </p>
      </article>
    );
  }
  ...
  return (
    <section className="mx-4 xl:mx-20 2xl:mx-40 my-6 xl:my-10">
      ...
      <div className="flex flex-col xl:grid grid-cols-3 gap-5">
        {/* <InfoItem
        ...
        <InfoItem infoItems={infoItems} />
        <div className="col-span-2 h-full">
          <CTAItem CTAItems={CTAItems} />
        </div>
      </div>
    </section>
  );
